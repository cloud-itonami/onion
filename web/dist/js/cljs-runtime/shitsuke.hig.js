...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23217){
var vec__23218 = p__23217;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23218,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23218,(1),null);
 ...
 */
shitsuke.hig.default_hig_tokens = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword("hig","font","hig/font",-1506004751),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"text","text",-1790561697),shitsuke.hig.font_family_text,new cljs.core.Keyword(null,"display","display",242065432),shitsuke.hig.font_family_display,new cljs.core.Keyword(null,"mono","mono",-1777958350),shitsuke.hig.font_family_mono], null),new cljs.core.Keyword("hig","text","hig/text",-1790736923),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23259){
var vec__23276 = p__23259;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23276,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23276,(1),null);
...
})),shitsuke.hig.text_styles),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23280){
var vec__23281 = p__23280;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23281,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23281,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$pair__GT_css_$_iter__23292(s__23293){
return (new cljs.core.LazySeq(null,(function (){
var s__23293__$1 = s__23293;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23293__$1);
if(temp__5825__auto__){
var s__23293__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23293__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23293__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23295 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23294 = (0);
while(true){
if((i__23294 < size__5479__auto__)){
var vec__23296 = cljs.core._nth(c__5478__auto__,i__23294);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23296,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23296,(1),null);
cljs.core.chunk_append(b__23295,["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__23570 = (i__23294 + (1));
i__23294 = G__23570;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23295),shitsuke$hig$pair__GT_css_$_iter__23292(cljs.core.chunk_rest(s__23293__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23295),null);
}
} else {
var vec__23299 = cljs.core.first(s__23293__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23299,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23299,(1),null);
return cljs.core.cons(["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$hig$pair__GT_css_$_iter__23292(cljs.core.rest(s__23293__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$tokens__GT_css_lines_$_iter__23303(s__23304){
return (new cljs.core.LazySeq(null,(function (){
var s__23304__$1 = s__23304;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23304__$1);
if(temp__5825__auto__){
var s__23304__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23304__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23304__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23306 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23305 = (0);
while(true){
if((i__23305 < size__5479__auto__)){
var vec__23369 = cljs.core._nth(c__5478__auto__,i__23305);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23369,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23369,(1),null);
if((!((m == null)))){
cljs.core.chunk_append(b__23306,((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (i__23305,s__23304__$1,vec__23369,group,m,c__5478__auto__,size__5479__auto__,b__23306,s__23304__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23303_$_iter__23373(s__23374){
return (new cljs.core.LazySeq(null,((function (i__23305,s__23304__$1,vec__23369,group,m,c__5478__auto__,size__5479__auto__,b__23306,s__23304__$2,temp__5825__auto__){
return (function (){
var s__23374__$1 = s__23374;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23374__$1);
if(temp__5825__auto____$1){
var s__23374__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__23374__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__23374__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__23376 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__23375 = (0);
while(true){
if((i__23375 < size__5479__auto____$1)){
var vec__23395 = cljs.core._nth(c__5478__auto____$1,i__23375);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23395,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23395,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__23376,shitsuke.hig.pair__GT_css(group,k,v));

var G__23577 = (i__23375 + (1));
i__23375 = G__23577;
continue;
} else {
var G__23578 = (i__23375 + (1));
i__23375 = G__23578;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23376),shitsuke$hig$tokens__GT_css_lines_$_iter__23303_$_iter__23373(cljs.core.chunk_rest(s__23374__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23376),null);
}
} else {
var vec__23409 = cljs.core.first(s__23374__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23409,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23409,(1),null);
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23303_$_iter__23373(cljs.core.rest(s__23374__$2)));
} else {
var G__23579 = cljs.core.rest(s__23374__$2);
s__23374__$1 = G__23579;
continue;
}
}
} else {
...
});})(i__23305,s__23304__$1,vec__23369,group,m,c__5478__auto__,size__5479__auto__,b__23306,s__23304__$2,temp__5825__auto__))
,null,null));
});})(i__23305,s__23304__$1,vec__23369,group,m,c__5478__auto__,size__5479__auto__,b__23306,s__23304__$2,temp__5825__auto__))
;
...
var G__23580 = (i__23305 + (1));
i__23305 = G__23580;
continue;
} else {
var G__23581 = (i__23305 + (1));
i__23305 = G__23581;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23306),shitsuke$hig$tokens__GT_css_lines_$_iter__23303(cljs.core.chunk_rest(s__23304__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23306),null);
}
} else {
var vec__23417 = cljs.core.first(s__23304__$2);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23417,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23417,(1),null);
if((!((m == null)))){
return cljs.core.cons(((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (s__23304__$1,vec__23417,group,m,s__23304__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23303_$_iter__23420(s__23421){
return (new cljs.core.LazySeq(null,((function (s__23304__$1,vec__23417,group,m,s__23304__$2,temp__5825__auto__){
return (function (){
var s__23421__$1 = s__23421;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23421__$1);
if(temp__5825__auto____$1){
var s__23421__$2 = temp__5825__auto____$1;
...
var vec__23424 = cljs.core._nth(c__5478__auto__,i__23422);
...
if((!((v == null)))){
cljs.core.chunk_append(b__23423,shitsuke.hig.pair__GT_css(group,k,v));

var G__23583 = (i__23422 + (1));
i__23422 = G__23583;
continue;
} else {
var G__23584 = (i__23422 + (1));
i__23422 = G__23584;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23423),shitsuke$hig$tokens__GT_css_lines_$_iter__23303_$_iter__23420(cljs.core.chunk_rest(s__23421__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23423),null);
}
} else {
var vec__23428 = cljs.core.first(s__23421__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23428,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23428,(1),null);
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23303_$_iter__23420(cljs.core.rest(s__23421__$2)));
} else {
var G__23586 = cljs.core.rest(s__23421__$2);
s__23421__$1 = G__23586;
continue;
}
}
} else {
...
});})(s__23304__$1,vec__23417,group,m,s__23304__$2,temp__5825__auto__))
,null,null));
});})(s__23304__$1,vec__23417,group,m,s__23304__$2,temp__5825__auto__))
;
return iter__5480__auto__(m);
})()):["  --hig-",cljs.core.name(group),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),";"].join('')),shitsuke$hig$tokens__GT_css_lines_$_iter__23303(cljs.core.rest(s__23304__$2)));
} else {
var G__23587 = cljs.core.rest(s__23304__$2);
s__23304__$1 = G__23587;
continue;
}
}
} else {
 ...
 *   `@layer kotoba.hig`.
 */
shitsuke.hig.text_style_classes = ["@layer kotoba.hig {\n",clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$iter__23446(s__23447){
return (new cljs.core.LazySeq(null,(function (){
var s__23447__$1 = s__23447;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23447__$1);
if(temp__5825__auto__){
var s__23447__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23447__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23447__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23449 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23448 = (0);
while(true){
if((i__23448 < size__5479__auto__)){
var style = cljs.core._nth(c__5478__auto__,i__23448);
cljs.core.chunk_append(b__23449,[".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''));

var G__23602 = (i__23448 + (1));
i__23448 = G__23602;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23449),shitsuke$hig$iter__23446(cljs.core.chunk_rest(s__23447__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23449),null);
}
} else {
var style = cljs.core.first(s__23447__$2);
return cljs.core.cons([".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''),shitsuke$hig$iter__23446(cljs.core.rest(s__23447__$2)));
}
} else {
return null;
}
