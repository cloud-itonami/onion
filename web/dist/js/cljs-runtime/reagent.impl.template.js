...
var G__22754 = o;
reagent.impl.template.goog$module$goog$object.set(G__22754,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__22830__delegate = function (args){
...
while (G__22831__i < G__22831__a.length) {G__22831__a[G__22831__i] = arguments[G__22831__i + 0]; ++G__22831__i;}
  args = new cljs.core.IndexedSeq(G__22831__a,0,null);
} 
return G__22830__delegate.call(this,args);};
...
return G__22830__delegate(args);
});
...
var G__22755 = o;
reagent.impl.template.goog$module$goog$object.set(G__22755,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22834__i < G__22834__a.length) {G__22834__a[G__22834__i] = arguments[G__22834__i + 0]; ++G__22834__i;}
  args = new cljs.core.IndexedSeq(G__22834__a,0,null);
} 
...
var args = cljs.core.seq(arglist__22835);
...
var G__22758 = props;
var G__22758__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22758,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22758);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22758__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22760 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22760,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22760;
}
})(),id_class);
...
var G__22761 = (cljs.core.count(argv) - first_child);
switch (G__22761) {
case (0):
...
var vec__22762 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22762,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22762,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22762,(2),null);
...
var temp__5829__auto___22844 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22844 == null)){
} else {
var key_22845 = temp__5829__auto___22844;
(jsprops.key = key_22845);
}
...
var temp__5829__auto___22847 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22847 == null)){
} else {
var key_22848 = temp__5829__auto___22847;
(jsprops.key = key_22848);
}
...
var temp__5829__auto___22852 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22852 == null)){
} else {
var key_22853 = temp__5829__auto___22852;
(jsprops.key = key_22853);
}
...
var temp__5829__auto___22861 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22861 == null)){
} else {
var key_22862 = temp__5829__auto___22861;
(jsprops.key = key_22862);
}
...
var temp__5829__auto___22863 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22863 == null)){
} else {
var key_22864 = temp__5829__auto___22863;
(jsprops.key = key_22864);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22765_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22765_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22766 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22766,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22766,(1),null);
...
break;
default:
var G__22874 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22875 = compiler;
v = G__22874;
compiler = G__22875;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22819 = (function (opts,id,fn_to_element,parse_fn,meta22820){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22819.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22821,meta22820__$1){
var self__ = this;
var _22821__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22819(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22820__$1));
}));

(reagent.impl.template.t_reagent$impl$template22819.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22821){
var self__ = this;
var _22821__$1 = this;
return self__.meta22820;
}));

(reagent.impl.template.t_reagent$impl$template22819.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22819.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22819.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22819.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22819.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22819.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22820","meta22820",975728311,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22819.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22819.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22819");

(reagent.impl.template.t_reagent$impl$template22819.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22819");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22819.
 */
reagent.impl.template.__GT_t_reagent$impl$template22819 = (function reagent$impl$template$__GT_t_reagent$impl$template22819(opts,id,fn_to_element,parse_fn,meta22820){
return (new reagent.impl.template.t_reagent$impl$template22819(opts,id,fn_to_element,parse_fn,meta22820));
});
...
return (new reagent.impl.template.t_reagent$impl$template22819(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
