...
var len__5726__auto___22106 = arguments.length;
var i__5727__auto___22107 = (0);
while(true){
if((i__5727__auto___22107 < len__5726__auto___22106)){
args__5732__auto__.push((arguments[i__5727__auto___22107]));

var G__22108 = (i__5727__auto___22107 + (1));
i__5727__auto___22107 = G__22108;
continue;
} else {
}
break;
...
/** @this {Function} */
(shitsuke.tokens.deep_merge.cljs$lang$applyTo = (function (seq22003){
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$pair__GT_css_$_iter__22009(s__22010){
return (new cljs.core.LazySeq(null,(function (){
var s__22010__$1 = s__22010;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22010__$1);
if(temp__5825__auto__){
var s__22010__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22010__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22010__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22012 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22011 = (0);
while(true){
if((i__22011 < size__5479__auto__)){
var vec__22014 = cljs.core._nth(c__5478__auto__,i__22011);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22014,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22014,(1),null);
cljs.core.chunk_append(b__22012,["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22111 = (i__22011 + (1));
i__22011 = G__22111;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22012),shitsuke$tokens$pair__GT_css_$_iter__22009(cljs.core.chunk_rest(s__22010__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22012),null);
}
} else {
var vec__22028 = cljs.core.first(s__22010__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22028,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22028,(1),null);
return cljs.core.cons(["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$tokens$pair__GT_css_$_iter__22009(cljs.core.rest(s__22010__$2)));
}
} else {
return null;
}
...
var body = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$iter__22036(s__22037){
return (new cljs.core.LazySeq(null,(function (){
var s__22037__$1 = s__22037;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22037__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__22044 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22044,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22044,(1),null);
var iterys__5476__auto__ = ((function (s__22037__$1,vec__22044,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function shitsuke$tokens$iter__22036_$_iter__22038(s__22039){
return (new cljs.core.LazySeq(null,((function (s__22037__$1,vec__22044,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__22039__$1 = s__22039;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22039__$1);
if(temp__5825__auto____$1){
var s__22039__$2 = temp__5825__auto____$1;
...
var vec__22051 = cljs.core._nth(c__5478__auto__,i__22040);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22041,shitsuke.tokens.pair__GT_css(group,k,v));

var G__22127 = (i__22040 + (1));
i__22040 = G__22127;
continue;
} else {
var G__22128 = (i__22040 + (1));
i__22040 = G__22128;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22041),shitsuke$tokens$iter__22036_$_iter__22038(cljs.core.chunk_rest(s__22039__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22041),null);
}
} else {
var vec__22054 = cljs.core.first(s__22039__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22054,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22054,(1),null);
if((!((v == null)))){
return cljs.core.cons(shitsuke.tokens.pair__GT_css(group,k,v),shitsuke$tokens$iter__22036_$_iter__22038(cljs.core.rest(s__22039__$2)));
} else {
var G__22130 = cljs.core.rest(s__22039__$2);
s__22039__$1 = G__22130;
continue;
}
}
} else {
...
});})(s__22037__$1,vec__22044,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__22037__$1,vec__22044,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,shitsuke$tokens$iter__22036(cljs.core.rest(s__22037__$1)));
} else {
var G__22131 = cljs.core.rest(s__22037__$1);
s__22037__$1 = G__22131;
continue;
}
} else {
return null;
...
var map__22082 = deck_design;
var map__22082__$1 = cljs.core.__destructure_map(map__22082);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22082__$1,new cljs.core.Keyword("slides","theme","slides/theme",-79736158));
var text_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22082__$1,new cljs.core.Keyword("slides","text-styles","slides/text-styles",-2082623934));
...
var color_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22083){
var vec__22084 = p__22083;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22084,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22084,(1),null);
...
var type_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22087){
var vec__22088 = p__22087;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22088,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22088,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,(function (){var G__22091 = cljs.core.PersistentArrayMap.EMPTY;
var G__22091__$1 = (cljs.core.truth_(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22091,new cljs.core.Keyword(null,"font-size","font-size",-1847940346),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts)),"px"].join('')):G__22091);
var G__22091__$2 = (cljs.core.truth_(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22091__$1,new cljs.core.Keyword(null,"color","color",1011675173),shitsuke.tokens.normalize_hex(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))):G__22091__$1);
if(cljs.core.truth_(new cljs.core.Keyword("slides","bold","slides/bold",-1297473049).cljs$core$IFn$_invoke$arity$1(ts))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22091__$2,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(700));
} else {
return G__22091__$2;
}
})()], null);
})),text_styles);
var font_family = (function (){var or__5002__auto__ = (function (){var G__22095 = new cljs.core.Keyword("office-style.font","majorFont","office-style.font/majorFont",1886256746).cljs$core$IFn$_invoke$arity$1(fonts);
if((G__22095 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22095),", system-ui, sans-serif"].join('');
}
})();
...
var G__22096 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("shitsuke","colors","shitsuke/colors",-494612392),color_tokens], null);
if(cljs.core.seq(type_tokens)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22096,new cljs.core.Keyword("shitsuke","type","shitsuke/type",1602529816),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22097){
var vec__22098 = p__22097;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22098,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22098,(1),null);
