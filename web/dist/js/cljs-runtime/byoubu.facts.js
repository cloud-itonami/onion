...
return byoubu.color.mix((function (){var iter__5480__auto__ = (function byoubu$facts$declared_content_color_$_iter__22907(s__22908){
...
var vec__22912 = cljs.core._nth(c__5478__auto__,i__22909);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22912,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22912,(1),null);
cljs.core.chunk_append(b__22910,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null));

var G__23083 = (i__22909 + (1));
i__22909 = G__23083;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22910),byoubu$facts$declared_content_color_$_iter__22907(cljs.core.chunk_rest(s__22908__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22910),null);
}
} else {
var vec__22915 = cljs.core.first(s__22908__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22915,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22915,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null),byoubu$facts$declared_content_color_$_iter__22907(cljs.core.rest(s__22908__$2)));
}
} else {
return null;
}
...
var G__22918 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"declared","declared",92336021),byoubu.facts.declared_content_color(backdrop)], null);
var G__22918__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22918,new cljs.core.Keyword(null,"plate","plate",-1920178141),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null))):G__22918);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22918__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"poster","poster",-1616913550),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)));
} else {
return G__22918__$1;
}
});
...
return cljs.core.first(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__22949){
var vec__22950 = p__22949;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22950,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22950,(1),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22950,(2),null);
return (- r);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22953){
var vec__22954 = p__22953;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22954,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22954,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,hex,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22922_SHARP_){
var or__5002__auto__ = byoubu.color.contrast_ratio(hex,p1__22922_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
var vec__22962 = byoubu.facts.best_ink(cljs.core.vals(tiers));
var ink_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22962,(0),null);
var ink = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22962,(1),null);
var ratio = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22962,(2),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22970),byoubu$facts$derive_facts_$_iter__22967(cljs.core.chunk_rest(s__22968__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22970),null);
}
} else {
var vec__23040 = cljs.core.first(s__22968__$2);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23040,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23040,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null),byoubu$facts$derive_facts_$_iter__22967(cljs.core.rest(s__22968__$2)));
}
} else {
return null;
}
