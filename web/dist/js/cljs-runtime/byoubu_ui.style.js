...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",(function (){var iter__5480__auto__ = (function byoubu_ui$style$stops_str_$_iter__23452(s__23453){
...
var map__23456 = cljs.core._nth(c__5478__auto__,i__23454);
var map__23456__$1 = cljs.core.__destructure_map(map__23456);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23456__$1,new cljs.core.Keyword("plate","color","plate/color",914427071));
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23456__$1,new cljs.core.Keyword("plate","at","plate/at",1101651535));
cljs.core.chunk_append(b__23455,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(color)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(at)].join(''));

var G__23488 = (i__23454 + (1));
i__23454 = G__23488;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23455),byoubu_ui$style$stops_str_$_iter__23452(cljs.core.chunk_rest(s__23453__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23455),null);
}
} else {
var map__23457 = cljs.core.first(s__23453__$2);
var map__23457__$1 = cljs.core.__destructure_map(map__23457);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23457__$1,new cljs.core.Keyword("plate","color","plate/color",914427071));
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23457__$1,new cljs.core.Keyword("plate","at","plate/at",1101651535));
return cljs.core.cons([cljs.core.str.cljs$core$IFn$_invoke$arity$1(color)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(at)].join(''),byoubu_ui$style$stops_str_$_iter__23452(cljs.core.rest(s__23453__$2)));
}
} else {
return null;
}
 ...
 */
byoubu_ui.style.layer_str = (function byoubu_ui$style$layer_str(p__23458){
var map__23459 = p__23458;
var map__23459__$1 = cljs.core.__destructure_map(map__23459);
var kind = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23459__$1,new cljs.core.Keyword("plate","kind","plate/kind",-1424213105));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23459__$1,new cljs.core.Keyword("plate","direction","plate/direction",-651904309));
var shape = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23459__$1,new cljs.core.Keyword("plate","shape","plate/shape",1889905040));
var stops = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23459__$1,new cljs.core.Keyword("plate","stops","plate/stops",-1312702775));
var G__23460 = kind;
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var iter__5480__auto__ = (function byoubu_ui$style$component_css_$_iter__23461(s__23462){
return (new cljs.core.LazySeq(null,(function (){
var s__23462__$1 = s__23462;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23462__$1);
if(temp__5825__auto__){
var s__23462__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23462__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23462__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23464 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23463 = (0);
while(true){
if((i__23463 < size__5479__auto__)){
var vec__23465 = cljs.core._nth(c__5478__auto__,i__23463);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23465,(0),null);
var decls = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23465,(1),null);
cljs.core.chunk_append(b__23464,css.core.rule(sel,decls));

var G__23494 = (i__23463 + (1));
i__23463 = G__23494;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23464),byoubu_ui$style$component_css_$_iter__23461(cljs.core.chunk_rest(s__23462__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23464),null);
}
} else {
var vec__23468 = cljs.core.first(s__23462__$2);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23468,(0),null);
var decls = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23468,(1),null);
return cljs.core.cons(css.core.rule(sel,decls),byoubu_ui$style$component_css_$_iter__23461(cljs.core.rest(s__23462__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5480__auto__ = (function byoubu_ui$style$component_css_$_iter__23471(s__23472){
return (new cljs.core.LazySeq(null,(function (){
var s__23472__$1 = s__23472;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23472__$1);
if(temp__5825__auto__){
var s__23472__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23472__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23472__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23474 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23473 = (0);
while(true){
if((i__23473 < size__5479__auto__)){
var vec__23475 = cljs.core._nth(c__5478__auto__,i__23473);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23475,(0),null);
var rules = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23475,(1),null);
cljs.core.chunk_append(b__23474,css.core.media(q,rules));

var G__23499 = (i__23473 + (1));
i__23473 = G__23499;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23474),byoubu_ui$style$component_css_$_iter__23471(cljs.core.chunk_rest(s__23472__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23474),null);
}
} else {
var vec__23478 = cljs.core.first(s__23472__$2);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23478,(0),null);
var rules = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23478,(1),null);
return cljs.core.cons(css.core.media(q,rules),byoubu_ui$style$component_css_$_iter__23471(cljs.core.rest(s__23472__$2)));
}
} else {
return null;
}
