...
(liquid_glass.tokens.spring_linear_easing.cljs$core$IFn$_invoke$arity$1 = (function (p__22115){
var map__22116 = p__22115;
var map__22116__$1 = cljs.core.__destructure_map(map__22116);
var zeta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22116__$1,new cljs.core.Keyword(null,"zeta","zeta",257464678),0.55);
var omega = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22116__$1,new cljs.core.Keyword(null,"omega","omega",277265652),13.0);
var samples = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22116__$1,new cljs.core.Keyword(null,"samples","samples",635504833),(16));
...
return ["linear(",clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$iter__22121(s__22122){
...
var i = cljs.core._nth(c__5478__auto__,i__22123);
cljs.core.chunk_append(b__22124,fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))));

var G__22252 = (i__22123 + (1));
i__22123 = G__22252;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22124),liquid_glass$tokens$iter__22121(cljs.core.chunk_rest(s__22122__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22124),null);
}
} else {
var i = cljs.core.first(s__22122__$2);
return cljs.core.cons(fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))),liquid_glass$tokens$iter__22121(cljs.core.rest(s__22122__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$pair__GT_css_$_iter__22146(s__22147){
return (new cljs.core.LazySeq(null,(function (){
var s__22147__$1 = s__22147;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22147__$1);
if(temp__5825__auto__){
var s__22147__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22147__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22147__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22149 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22148 = (0);
while(true){
if((i__22148 < size__5479__auto__)){
var vec__22150 = cljs.core._nth(c__5478__auto__,i__22148);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22150,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22150,(1),null);
cljs.core.chunk_append(b__22149,["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22289 = (i__22148 + (1));
i__22148 = G__22289;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22149),liquid_glass$tokens$pair__GT_css_$_iter__22146(cljs.core.chunk_rest(s__22147__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22149),null);
}
} else {
var vec__22153 = cljs.core.first(s__22147__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22153,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22153,(1),null);
return cljs.core.cons(["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),liquid_glass$tokens$pair__GT_css_$_iter__22146(cljs.core.rest(s__22147__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$tokens__GT_body_$_iter__22156(s__22157){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22163 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22163,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22163,(1),null);
var iterys__5476__auto__ = ((function (s__22157__$1,vec__22163,group,m,xs__6385__auto__,temp__5825__auto__){
return (function liquid_glass$tokens$tokens__GT_body_$_iter__22156_$_iter__22158(s__22159){
return (new cljs.core.LazySeq(null,((function (s__22157__$1,vec__22163,group,m,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__22159__$1 = s__22159;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22159__$1);
if(temp__5825__auto____$1){
var s__22159__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22159__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22159__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22161 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22160 = (0);
while(true){
if((i__22160 < size__5479__auto__)){
var vec__22166 = cljs.core._nth(c__5478__auto__,i__22160);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22166,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22166,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__22161,liquid_glass.tokens.pair__GT_css(group,k,v));

var G__22292 = (i__22160 + (1));
i__22160 = G__22292;
continue;
} else {
var G__22293 = (i__22160 + (1));
i__22160 = G__22293;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22161),liquid_glass$tokens$tokens__GT_body_$_iter__22156_$_iter__22158(cljs.core.chunk_rest(s__22159__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22161),null);
}
} else {
var vec__22174 = cljs.core.first(s__22159__$2);
...
if((!((v == null)))){
return cljs.core.cons(liquid_glass.tokens.pair__GT_css(group,k,v),liquid_glass$tokens$tokens__GT_body_$_iter__22156_$_iter__22158(cljs.core.rest(s__22159__$2)));
} else {
var G__22294 = cljs.core.rest(s__22159__$2);
s__22159__$1 = G__22294;
continue;
}
}
} else {
...
});})(s__22157__$1,vec__22163,group,m,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22157__$1,vec__22163,group,m,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,liquid_glass$tokens$tokens__GT_body_$_iter__22156(cljs.core.rest(s__22157__$1)));
} else {
var G__22295 = cljs.core.rest(s__22157__$1);
s__22157__$1 = G__22295;
continue;
}
} else {
return null;
