...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,(function (){var G__21837 = cljs.core.PersistentArrayMap.EMPTY;
var G__21837__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21837,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes)):G__21837);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21837__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__21837__$1;
}
})()], null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("",cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__21841){
var vec__21842 = p__21841;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21842,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21842,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__21849){
var vec__21850 = p__21849;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21850,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21850,(1),null);
if(cljs.core.truth_((function (){var and__5000__auto__ = v;
if(cljs.core.truth_(and__5000__auto__)){
return (!(v === false));
} else {
...
var vec__21853 = html.core.parse_tag(cljs.core.first(x));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21853,(0),null);
...
var t = first__21872;
var body = seq__21871__$1;
var vec__21873 = html.core.parse_tag(t);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21873,(0),null);
var base = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21873,(1),null);
var vec__21876 = ((cljs.core.map_QMARK_(cljs.core.first(body)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.rest(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,body], null));
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21876,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21876,(1),null);
...
/** @this {Function} */
(html.core.html.cljs$lang$applyTo = (function (seq21883){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21883));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___21906 = arguments.length;
var i__5727__auto___21907 = (0);
while(true){
if((i__5727__auto___21907 < len__5726__auto___21906)){
args__5732__auto__.push((arguments[i__5727__auto___21907]));

var G__21908 = (i__5727__auto___21907 + (1));
i__5727__auto___21907 = G__21908;
continue;
} else {
}
break;
...
/** @this {Function} */
(html.core.html5.cljs$lang$applyTo = (function (seq21887){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21887));
}));
