...
return [":root { ",clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",(function (){var iter__5480__auto__ = (function byoubu_ui$tokens$iter__22997(s__22998){
return (new cljs.core.LazySeq(null,(function (){
var s__22998__$1 = s__22998;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22998__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__23003 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23003,(0),null);
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23003,(1),null);
var iterys__5476__auto__ = ((function (s__22998__$1,vec__23003,group,ks,xs__6385__auto__,temp__5825__auto__,tokens){
return (function byoubu_ui$tokens$iter__22997_$_iter__22999(s__23000){
return (new cljs.core.LazySeq(null,((function (s__22998__$1,vec__23003,group,ks,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__23000__$1 = s__23000;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23000__$1);
if(temp__5825__auto____$1){
var s__23000__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__23000__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23000__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23002 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23001 = (0);
while(true){
if((i__23001 < size__5479__auto__)){
var vec__23008 = cljs.core._nth(c__5478__auto__,i__23001);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23008,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23008,(1),null);
cljs.core.chunk_append(b__23002,[byoubu_ui.tokens.var_name(cljs.core.name(group),k),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join(''));

var G__23124 = (i__23001 + (1));
i__23001 = G__23124;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23002),byoubu_ui$tokens$iter__22997_$_iter__22999(cljs.core.chunk_rest(s__23000__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23002),null);
}
} else {
var vec__23013 = cljs.core.first(s__23000__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23013,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23013,(1),null);
return cljs.core.cons([byoubu_ui.tokens.var_name(cljs.core.name(group),k),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join(''),byoubu_ui$tokens$iter__22997_$_iter__22999(cljs.core.rest(s__23000__$2)));
}
} else {
return null;
}
...
});})(s__22998__$1,vec__23003,group,ks,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__22998__$1,vec__23003,group,ks,xs__6385__auto__,temp__5825__auto__,tokens))
;
...
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,byoubu_ui$tokens$iter__22997(cljs.core.rest(s__22998__$1)));
} else {
var G__23235 = cljs.core.rest(s__22998__$1);
s__22998__$1 = G__23235;
continue;
}
} else {
return null;
